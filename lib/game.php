<?php
    ...
    function check_abort() {
        ...
        $sql = "update game_status set status='aborded', result=if(p_turn='A','B','A'),p_turn=null where p_turn is not null and last_change<(now()-INTERVAL 5 MINUTE) and status='started'";
        $st = $mysqli->prepare($sql);
        $r = $st->execute();
    }
